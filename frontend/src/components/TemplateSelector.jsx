    ...
    const templates = [
        {
            id: "classic",
            name: "Classic",
            preview: "A clean, tranitional resume formate with clean sections and professional typography"
        },
        {
            id: "modern",
            name: "Modern",
            preview: "Sleek design with strategic use of color and modren font"
        },
        {
            id: "minimal",
            name: "Minimal",
    ...
    return (
        <div className='relative'>
            <button
                ...
                className='flex items-center gap-1 text-sm text-blue-600 bg-gradient-to-br from-blue-50 to-blue-300 ring-blue-300 hover:ring transition-all px-3 py-2 rounded-lg'
            >
                <Layout
                    size={14}
                />
                        ...
                        >
                            {selectedTemplate === template.id && (
                                <div className='absolute top-2 right-2'>
                                    <div className='szie-5 bg-blue-400 rounded-full flex items-center justify-center'>
                                        <CheckIcon
