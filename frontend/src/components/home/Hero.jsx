        ...
        <>
            <div className="min-h-screen pb-20">
                ...
                <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
                    <h1 className='text-3xl font-bold text-green-600'>Elevate<span className='text-black'>Me.</span></h1>
                ...
                <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
                    ...
                    <h1 className="text-5xl md:text-6xl font-semibold max-w-5xl text-center mt-4 md:leading-[70px]">
                        Build your perfect resume. <span className=" bg-gradient-to-r from-green-700 to-green-600 bg-clip-text text-transparent text-nowrap">Get hired </span>  faster.
                    </h1>

                    <p className="max-w-md text-center text-base my-7">Don't just apply. Stand out! Craft a professional resume designed to pass ATS and impress recruiters.</p>
