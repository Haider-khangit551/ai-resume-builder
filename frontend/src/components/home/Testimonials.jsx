    ...
    const CreateCard = ({ card }) => (
        <div className="p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0 bg-white">
            ...
            <p className="text-sm py-4 text-gray-800">
                ElevateMe made crafting my resume easier and more professional than ever!
            </p>
        </div>
    );
    ...
    return (
        <div id="testimonials" className="flex flex-col items-center my-10 scroll-mt-12">
            <div className="flex items-center gap-2 text-sm text-green-800 bg-green-400/10 border border-green-200 rounded-full px-4 py-1">
                <BookUserIcon width={15} className="size-4.5 stroke-green-600" />
                <span>Testimonials</span>
            </div>

            <Title
                title="What Our Users Say"
                description="Hear from professionals who used ElevateMe to craft smarter, AI-enhanced resumes that helped them land interviews and dream jobs."
            />
