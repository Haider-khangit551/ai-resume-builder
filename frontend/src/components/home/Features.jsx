...
const Features = () => {
    ...
    return (
        <div id='features' className='flex flex-col items-center my-10 scroll-mt-12'>
            ...
            <Title title='Build Your Resume' description='Create a standout, professional resume in minutes with AI-powered guidance and smart design tools.' />
                    ...
                    <div className={"flex items-center justify-center gap-6 max-w-md group cursor-pointer"}>
                        <div className={`p-6 group-hover:bg-violet-100 border border-transparent group-hover:border-violet-300  flex gap-4 rounded-xl transition-colors ${!isHover ? 'border-violet-300 bg-violet-100' : ''}`}>
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Login / Sign Up</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Access the platform by signing in or creating a free account to start building your resume.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-green-100 border border-transparent group-hover:border-green-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Provide Your Details</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Fill in your experience, skills, and education so our AI can craft a tailored resume for you.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-orange-100 border border-transparent group-hover:border-orange-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Download Resume</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Save your professionally designed resume as PDF and share it with employers instantly.</p>
                            </div>
                        </div>
                    </div>
                </div>
