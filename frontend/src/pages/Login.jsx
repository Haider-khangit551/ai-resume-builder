import { Eye, EyeClosed, Lock, Mail, User2Icon } from 'lucide-react'
    ...
    <div className='flex justify-center items-center min-h-screen bg-gray-50'>
      <form onSubmit={handleSubmit} className="sm:w-[350px] w-full text-center border border-gray-300/60 rounded-2xl px-8 bg-white">
        ...
        <div className="flex items-center relative mt-4 w-full bg-white border border-gray-300/80 h-12 rounded-full overflow-hidden pl-6 gap-2">
          ...
          <div onClick={() => setShow(!show)} className='absolute right-4'>
            {
              show ? <EyeClosed size={15} color='#6B7280' /> : <Eye size={15} color='#6B7280' />
            }
          </div>
        </div>
